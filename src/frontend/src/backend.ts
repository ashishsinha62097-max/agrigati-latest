...
import type { ContactSubmission as _ContactSubmission, OrganizationType as _OrganizationType } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async submitContact(arg0: string, arg1: OrganizationType, arg2: string, arg3: string, arg4: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitContact(arg0, to_candid_OrganizationType_n6(this._uploadFile, this._downloadFile, arg1), arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_record_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        orgType: from_candid_OrganizationType_n4(_uploadFile, _downloadFile, value.orgType),
        name: value.name,
        email: value.email,
...
function from_candid_variant_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "FPO" in value ? OrganizationType.FPO : "other" in value ? OrganizationType.other : "buyer" in value ? OrganizationType.buyer : "farmer" in value ? OrganizationType.farmer : "investor" in value ? OrganizationType.investor : value;
}
...
function to_candid_OrganizationType_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: OrganizationType): _OrganizationType {
    return to_candid_variant_n7(_uploadFile, _downloadFile, value);
}
function to_candid_variant_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: OrganizationType): {
    FPO: null;
} | {
    other: null;
} | {
    ...
    return value == OrganizationType.FPO ? {
        FPO: null
    } : value == OrganizationType.other ? {
        other: null
    } : value == OrganizationType.buyer ? {
        buyer: null
    } : value == OrganizationType.farmer ? {
        farmer: null
    } : value == OrganizationType.investor ? {
        investor: null
    } : value;
}
